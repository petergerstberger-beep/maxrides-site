...
(function () {
  ...
  var BIKES = [
    // ===== DIRT =====
    {
      ...
      cutoutUrl: 'assets/img/bikes/cut/sur-ron-light-bee-x.webp',
    ...
    },
    {
      ...
      tier: 'premium',
      silhouette: 'dirt',
      photoUrl: 'assets/img/bikes/sur-ron-ultra-bee.png',
      cutoutUrl: 'assets/img/bikes/cut/sur-ron-ultra-bee.webp',
    ...
    },
    {
      ...
      cutoutUrl: 'assets/img/bikes/cut/talaria-dragon.webp',
    ...
    },
    {
      ...
      cutoutUrl: 'assets/img/bikes/cut/talaria-sting-mx4.webp',
    ...
    },
    {
      ...
      cutoutUrl: 'assets/img/bikes/cut/stark-varg.webp',
    ...
    },
    {
      ...
      tier: 'premium',
      silhouette: 'dirt',
      photoUrl: 'assets/img/bikes/etm-rtr-xl.png',
      cutoutUrl: 'assets/img/bikes/cut/etm-rtr-xl.webp',
    ...
    },
    {
      ...
      tier: 'mid',
      silhouette: 'dirt',
      photoUrl: 'https://lithiumpowersports.com/cdn/shop/files/etm-rtr-sport-ready-to-rip-electric-trail-machine-bike-erides-994.webp?v=1773421026',
      cutoutUrl: 'assets/img/bikes/cut/etm-rtr-sport.webp',
    ...
    },
    {
      ...
      tier: 'budget',
      silhouette: 'starter',
      photoUrl: 'assets/img/bikes/etm-rtr-lite.png',
      cutoutUrl: 'assets/img/bikes/cut/etm-rtr-lite.webp',
    ...
    },
    {
      ...
      tier: 'mid',
      silhouette: 'dirt',
      photoUrl: 'https://cdn.prod.website-files.com/6675b4f433c2c32076d88aa3/69123976bbbff8d879a9c4ba_rawrr_mantis_x.webp',
      cutoutUrl: 'assets/img/bikes/cut/rawrr-mantis.webp',
    ...
    // ===== STREET =====
    {
      ...
      cutoutUrl: 'assets/img/bikes/cut/super73-rx.webp',
    ...
    },
    {
      ...
      cutoutUrl: 'assets/img/bikes/cut/super73-zx.webp',
    ...
    },
    {
      ...
      cutoutUrl: 'assets/img/bikes/cut/onyx-rcr.webp',
    ...
    // ===== COMMUTER =====
    {
      ...
      cutoutUrl: 'assets/img/bikes/cut/super73-zx-le-speedway.webp',
    ...
    },
    {
      ...
      options: [
        ...
        { id: 'plate-orange', name: 'Orange plate', brand: 'ODI', tier: 'budget',
          ...
          specs: { material: 'Impact-resistant polymer', mount: 'Universal triple-clamp', graphic: 'White vinyl (custom #)' } },
        { id: 'plate-white', name: 'White plate', brand: 'ODI', tier: 'budget',
          priceDelta: 45, summary: 'Classic MX look.',
          specs: { material: 'Impact-resistant polymer', mount: 'Universal triple-clamp', graphic: 'Black vinyl (custom #)' } },
        { id: 'plate-black', name: 'Black plate', brand: 'ODI', tier: 'budget',
          priceDelta: 45, summary: 'Stealth.',
          specs: { material: 'Impact-resistant polymer', mount: 'Universal triple-clamp', graphic: 'White vinyl (custom #)' } },
        { id: 'plate-red', name: 'Race red plate', brand: 'ODI', tier: 'budget',
          priceDelta: 45, summary: 'Honda red, race-grade.',
          specs: { material: 'Impact-resistant polymer', mount: 'Universal triple-clamp', graphic: 'White vinyl (custom #)' } },
        { id: 'plate-blue', name: 'Cobalt blue plate', brand: 'ODI', tier: 'budget',
          priceDelta: 45, summary: 'Yamaha-blue race plate.',
          specs: { material: 'Impact-resistant polymer', mount: 'Universal triple-clamp', graphic: 'White vinyl (custom #)' } },
        { id: 'plate-lime', name: 'Acid lime plate', brand: 'ODI', tier: 'budget',
          priceDelta: 45, summary: 'Kawasaki-green visibility hit.',
          specs: { material: 'Impact-resistant polymer', mount: 'Universal triple-clamp', graphic: 'Black vinyl (custom #)' } },
        { id: 'plate-pink', name: 'Hot pink plate', brand: 'ODI', tier: 'budget',
          priceDelta: 45, summary: 'Stand-out plate. Hard to lose in a crowd.',
          specs: { material: 'Impact-resistant polymer', mount: 'Universal triple-clamp', graphic: 'Black vinyl (custom #)' } },
        { id: 'plate-yellow', name: 'School-bus yellow plate', brand: 'ODI', tier: 'budget',
          priceDelta: 45, summary: 'Suzuki yellow MX classic.',
          specs: { material: 'Impact-resistant polymer', mount: 'Universal triple-clamp', graphic: 'Black vinyl (custom #)' } },
        ...
        { id: 'plate-carbon', name: 'Carbon fiber plate', brand: 'MTO Brothers', tier: 'mid',
          priceDelta: 159, summary: 'Real woven carbon fiber. Premium look.',
          specs: { material: 'Real carbon fiber', mount: 'Universal triple-clamp', graphic: 'Etched custom #' } },
        { id: 'plate-chrome', name: 'Chrome / mirror plate', brand: 'UXA', tier: 'mid',
          priceDelta: 95, summary: 'Polished chrome with mirror finish.',
          specs: { material: 'Vacuum-metallized polymer', mount: 'Universal triple-clamp', graphic: 'Black vinyl (custom #)' } },
        { id: 'plate-race-num', name: 'Race-numbered plate set', brand: 'ODI', tier: 'mid',
          priceDelta: 85, summary: 'AMA-spec race number kit. 3 plates (front + 2 side).',
          specs: { set: '3 plates (front + L/R sides)', graphic: 'AMA-spec race numbers', custom: 'Pick number / name' } }
      ]
    },
    {
      id: 'battery',
